      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="content-area">
            <!-- Title Area !-->
            <h1 class="main-heading">Batch Payments Paid</h1>
            <p class="main-sub-heading pb-4">
              List of all batch payments paid in the system
            </p>
            <!-- END Title Area !-->
          </div>
        </div>
      ...
      <div class="card-body">
        <div class="row card-table-header">
          <div class="col-md-6 col-sm-12">
            <div class="content-area">
              <h4 class="card-title text-brand">List of all Batches Paid</h4>
              <p class="card-text main-sub-heading pb-4 mt-0">
                <span class="total">2</span> batches paid currently in
                the system
              </p>
            </div>
          </div>
          ...
          <table id="payroll-ready-to-pay-payroll-table" class="table table-sm">
            <thead class="table-head">
              <tr>
                ...
                <th scope="col">To Pay Date</th>
                <th scope="col">No. Shifts</th>
