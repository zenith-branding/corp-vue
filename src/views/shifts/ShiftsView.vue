<template>
  ...
  <div class="main-wrapper container">
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="content-area">
            <!-- Title Area !-->
            <h1 class="main-heading">Shift</h1>
            <p class="main-sub-heading pb-4">
              List of all current Shift in the system
            </p>
            <!-- END Title Area !-->
          </div>
        </div>
    ...
    <div id="Shift-all-Shift" class="card card-table">
      <div class="card-body">
        <div class="row card-table-header">
          <div class="col-md-6 col-sm-12">
            <div class="content-area">
              <h4 class="card-title text-brand">Shift</h4>
              <p
                class="card-text main-sub-heading pb-4 mt-0"
                id="Shift-all-Shift-counts"
              >
                <span class="total">2</span> Shift currently in the system
              </p>
            </div>
          </div>
        </div>
        <div class="table-responsive hide-scroll-bars">
          <table id="Shift-all-Shift-table" class="table table-sm">
  ...
  created() {
    getAPI
      ...
      .then((response) => {
        ...
        this.$store.state.APIData = response.data.Shift
        this.status = "success"
      })
      .catch((err) => {
        console.log(err)
