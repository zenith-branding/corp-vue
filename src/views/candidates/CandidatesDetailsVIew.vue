                      ...
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between">
                          ...
                          <div class="button-area">
                            <router-link
                              to="/candidates/view/addresses/create"
                        ...
                        <ul class="list-group notes mt-4">
                          <li class="list-group-item position-relative">
                            <div class="p-2">
                              ...
                              MK10 0AN
                              <router-link
                                to="/candidates/view/addresses/view"
                                title="Edit Address"
                              >
                    ...
                    <div class="row button-row mb-3 p-1 pt-xl-0">
                      <div class="col-sm-12">
                        ...
                        <div class="table-responsive hide-scroll-bars pt-3">
                          <table
                            id="Candidates-all-Candidates-table"
                    ...
                    <div class="row button-row mb-3 p-1 pt-xl-0">
                      <div class="col-sm-12">
                        <div class="d-flex justify-content-between">
                          ...
                          <div class="button-area">
                            <router-link
                              to="/candidates/view/notes/create"
                              class="btn btn-primary"
                              title="Add New Note"
                              ><i class="far fa-plus icon left mr-2"></i>Add
                              Note</router-link
...
<script>
import LayoutCandidatesDetails from "./components/LayoutCandidatesDetails.vue"
